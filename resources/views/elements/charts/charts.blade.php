...
<script>
    ...
    const dadosSemSoftSkills = dadosComSoftSkills.map(valor => valor *
    0.5); // Garantir que "Sem Soft Skills" seja 50% de "Com Soft Skills"

    const barChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Comunicação', 'Trabalho em Equipe', 'Liderança', 'Gestão de Tempo',
