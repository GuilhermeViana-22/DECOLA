<nav class="navbar navbar-expand-lg ">
    <a class="navbar-brand" href="{{ route('home') }}"><img class="navbar-logo" src="{{ asset('arquivos/logos/1.png') }}"></a>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="cursoDrop">
                <a class="dropdown-item" href="{{ route('home') }}#cursos">Cursos disponíveis</a>
...
<script>
    ...
    if (window.location.hash) {
        ...
        if (element) {
            ...
            }, 200); // Pequeno delay para garantir carregamento
        }
    }
});
</script>
