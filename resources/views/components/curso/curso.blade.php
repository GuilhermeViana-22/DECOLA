                ...
                <div class="curso-card card shadow-lg border-0 rounded-lg position-relative">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex justify-content-center mb-3">
                            <div class="alert alert-warning w-100 p-3 d-flex justify-content-between align-items-center">
                                <span class="fw-bold text-dark">Oferta válida pelas próximas:</span>
...
<script>
    // Define the countdown time in hours
