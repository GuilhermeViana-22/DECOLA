<section class="bannerMobile py-5 bg-danger text-white">
    <div class="row justify-content-center">
        ...
        <div class="col-12 text-center mb-4">
            ...
            <button class="btn btn-light" id="saiba-mais-btn">Saiba Mais</button>
        </div>

        <!-- Formulário -->
        <div class="col-12 d-none" id="form-step-1">
            <div class="banner-form p-4 border rounded shadow-sm">
                ...
                <form id="form1">
                    ...
                    <button type="button" id="next-btn" class="btn btn-light w-100">Próximo</button>
                </form>
            </div>
        </div>

        <!-- Segundo Formulário -->
        <div class="col-12 d-none" id="form-step-2">
            <div class="banner-form p-4 border rounded shadow-sm">
