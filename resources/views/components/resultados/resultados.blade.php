<section class="why-choose-us py-5" style="background-color: #f5f5f5;">
    ...
    <div class="container">
      ...
      <div class="faq-section mt-5 text-center">
        ...
        <p class="faq-text mb-4">Dúvidas sobre estudar conosco? Nossa equipe de consultores e mentores está pronta para responder a todas as suas perguntas:</p>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="faq-item p-4 border rounded shadow-lg">
                    ...
                    <p>Receba o apoio de nossos mentores para ajudar no seu aprendizado de forma eficiente e direcionada.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="faq-item p-4 border rounded shadow-lg">
                    ...
                    <h4>Estudo Online</h4>
                    <p>Aprenda no seu ritmo, com a flexibilidade do ensino online, diretamente do conforto da sua casa.</p>
                </div>
            </div>
        </div>

        <button class="btn btn-primary btn-lg mt-4">
            <i class="fas fa-question-circle me-2"></i> Pergunte agora
        </button>
      </div>
    </div>
</section>
